...
- **Autentificare Completă**
  ...
  - Sistem de roluri (Administrator, User Înregistrat, User Neînregistrat)
...
- **Follow System**
  - Urmărește utilizatori cu profiluri publice
...
- **Controlul Vizibilității**
  ...
  - Doar owner-ul și administratorul pot edita/șterge conținut
...
- **Sistem de Roluri**
  - **Admin**: Acces complet la toate postările și utilizatori
  - **User**: Acces personalizat bazat pe relații de follow
  - # 🌐 MicroSocialPlatform
